...
The sample mean lobster size ($mm$) in the *MOHK* were *significantly* different between 2012 (77.3 ± 10.6 mm) and 2017 (72 ± 9.28 cm) according to a two-sample Student’s t-test (t(`r {ttest_MOHK$parameter}`) = `r {round(ttest_MOHK$statistic,3)}`, p < 0.001, $\alpha$ = 0.05). Additionally, the effect size is medium 
