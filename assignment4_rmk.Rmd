...
**Conclusion**: Proportions of lobsters that are above the minimum size requirement do not differ significantly by site ($\chi$^2^(`r {legal_chi$parameter}`) = `r {round(legal_chi$statistic, 3)}`, `r {round(legal_chi$p.value, 3)},  $\alpha$ = 0.05).  
