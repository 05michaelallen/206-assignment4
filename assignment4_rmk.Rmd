...
lsa_lt_table <- kable(lsa_lt_joined, 
                      format = "markdown",
                      caption = "Table 1. Lobster abundance (counts) and fishing pressure (trap buoys) at five Long Term Ecological Research Sites in Santa Barbara Channel (2012 -2017).",
